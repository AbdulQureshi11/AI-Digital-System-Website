...
const ProductSlide = () => {
  ...
  //  Sort products so latest appears first
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between gap-4">
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <button className="px-3 py-1.5 text-sm bg-[#002C8B] text-white rounded-md hover:bg-[#0041cc] transition">
                          {product.buttonText || "Read More"}
                        </button>
                        <button
